...
courseRouter.post("/create-course", user_controller_1.updateAccessToken, auth_1.isAuthenticated, (0, auth_1.authorizeRoles)("admin"), fileParser_1.fileParser, course_controller_1.uploadCourse);
// update course (admin)
